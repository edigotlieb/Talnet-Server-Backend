/**
 * FILE : Main.java AUTHORS : Erez Gotlieb
 */
...
/**
 * FILE : RuntimeParams.java AUTHORS : Erez Gotlieb DESCRIPTION : This class
 * encaps the access to the run-time parameters of the program
 */
