...
//<editor-fold defaultstate="collapsed" desc="open streams">
        try {
            ...
            this.reader = new BufferedReader(new InputStreamReader(socket.getInputStream(),"UTF-16"));            
            
            this.out = new PrintWriter(new OutputStreamWriter(this.socket.getOutputStream(), "UTF-16"));
